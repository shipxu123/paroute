...
namespace apiPy {
  ...
  class AnaroutePy {
   public:
    ...
    void parseGuide(const String_t& filename) { _par.parseGuide(filename); }

    /////////////////////////////////////
    // add data
    /////////////////////////////////////
    // void setPAGuide(const Int_t horGuide, const Int_t verGuide, const Int_t viaGuide) {
    //   _cir.setPAGuide(horGuide, verGuide, viaGuide);
    // }
    ...
    void setPADrCritical(Vector_t<Int_t>& v_critical) {
      _cir.setPADrCritical(v_critical);
    }
    ...
    void writePADumb(const String_t& placefilename, const String_t& outfilename) {
      _wr.writePADumb(placefilename, outfilename);
    }
...
void initPyAPI(py::module& m) {
  ...
  py::class_<apiPy::AnaroutePy>(m, "AnaroutePy")
    ...
    .def("parseGuide", &apiPy::AnaroutePy::parseGuide)
    .def("setPAGuide", &apiPy::AnaroutePy::setPAGuide)
    .def("setPADrCritical", &apiPy::AnaroutePy::setPADrCritical)
    ...
    .def("writePADumb", &apiPy::AnaroutePy::writePADumb)
